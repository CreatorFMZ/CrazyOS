...
pygame.display.set_caption("PYOS v1.3.3.1 - Python 操作系统模拟器")
...
MAXIMIZE_BUTTON = (100, 180, 100)
MAXIMIZE_HOVER = (120, 200, 120)
MINIMIZE_BUTTON = (220, 180, 80)
MINIMIZE_HOVER = (240, 200, 100)
SYSTEM_BLUE = (64, 156, 255)
DOCUMENT_BG = (60, 64, 74)
EDITOR_BG = (45, 50, 60)
SAVE_BUTTON = (70, 160, 110)
SAVE_HOVER = (90, 180, 130)
TEXT_HIGHLIGHT = (100, 180, 255, 100)
...
class DocumentStorage:
    def __init__(self):
        self.documents = {
            "welcome.txt": ["欢迎使用PYOS文档编辑器", "这是一个示例文档"],
...
class Window:
    def __init__(self, title, x, y, width, height, app_type):
        ...
        # 文档应用属性
        self.document_content = ["欢迎使用PYOS文档编辑器", "在这里输入您的文本...", "", "按Ctrl+S保存文档"]
    ...
    def init_browser(self):
        """初始化浏览器"""
        self.content = ["欢迎使用 PYOS 浏览器", "PYOS v1.3.3.1 已发布", 
                        "- 优化UI界面", "- 修复设置部分问题"]
        self.buttons.append({
