...
pygame.display.set_caption("CrazyOS 1.3 - Python 操作系统模拟器")
...
class Taskbar:
    ...
    def draw(self, surface):
        ...
        if self.start_menu_open:
            menu_rect = pygame.Rect(10, HEIGHT - self.height - 250, 200, 240)
        ...
        if event.type == pygame.QUIT:
            ...
            if not icon_clicked:
                ...
                if start_rect.collidepoint(mouse_pos):
                    ...
                    menu_rect = pygame.Rect(10, HEIGHT - taskbar.height - 250, 200, 240)
