...
pygame.display.set_caption("CrazyOS 1.1.1 - Python 操作系统模拟器")
...
class Window:
    def __init__(self, title, x, y, width, height, app_type):
        ...
        self.show_update = False  # 新增：显示更新信息
    ...
    def draw_settings(self, surface):
        ...
        if self.show_update:
            ...
            update_text = font_medium.render("请访问 https://github.com/CreatorFMZ/CrazyOS/tree/main/CrazyOS 获取最新版本", True, TEXT_COLOR)
            surface.blit(update_text, (update_rect.x + 30, update_rect.y + 30))
...
while running:
    ...
    screen.blit(date_text, (WIDTH - date_text.get_width() - 20, HEIGHT - 25))
